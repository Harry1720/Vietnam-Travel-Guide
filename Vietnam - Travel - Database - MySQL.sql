...
(7,'Lưu trú','Tại TP Nha Trang, du khách có thể chọn các khu khách sạn bình dân trong phố, các homestay, với giá từ 200.000 đồng một đêm. Dọc đường Trần Phú có các khách sạn cao cấp hơn như Mường Thanh, Melia Vinpearl, InterContinental, Sheraton với giá dao động từ một đến bốn triệu đồng một đêm. Cam Ranh tập trung nhiều resort, tiêu chuẩn sao quốc tế như: Ana Mandara Cam Ranh, The Anam Cam Ranh, Movenpick resort, Radisson Blu Resort, Meliá Vinpearl Cam Ranh Beach Resort, Cam Ranh Riviera Beach Resort & Spa, Selectum Noa Resort Cam Ranh, Duyên Hà resort, Alma Resort. Ở khu vực vịnh Ninh Vân, Six Senses Ninh Van Bay là khu nghỉ dưỡng có cảnh đẹp và không gian riêng tư. Giá phòng tại đây từ 15 triệu đồng một đêm. Ngoài ra còn có An Lam Retreats Ninh Van Bay, LAlya Ninh Van Bay, giá khoảng 10 triệu đồng một đêm.','https://res.cloudinary.com/dt5xizv10/image/upload/postDetail/sixsense'),
(7,'Tham quan','Thành phố Nha Trang Trần Phú là trục đường chạy dọc bãi biển, cũng là khu trung tâm của thành phố. Trên phố này và khu vực lân cận có nhiều nhà hàng và khách sạn. Điểm tập trung đông người tắm nhất là ở khu vực quanh tháp Trầm Hương. Bãi biển của thành phố được nhiều du khách đánh giá là trong, sạch, cát vàng mịn. Từ Nha Trang, du khách có thể tới nhiều hòn đảo như hòn Tre, hòn Chồng, hòn Mun, hòn Tằm đảo Yến - hòn Nội và trải nghiệm nhiều hoạt động trên biển. Đảo trong vịnh Nha Trang mang vẻ đẹp riêng, với làng chài, bãi tắm hoang sơ, vương quốc của loài khỉ hay những rạn san hô nhiều màu sắc.','https://res.cloudinary.com/dt5xizv10/image/upload/postDetail/tpntrang'),
(7,'Ẩm thực','Bánh căn - Nhắc đến ẩm thực Nha Trang nói riêng và Khánh Hòa nói chung, bánh căn thường lọt vào danh sách món ăn "phải thử". Những chiếc bánh nhỏ, giòn xốp, nướng bằng khuôn đất nung, không bị ngấy dầu mỡ, với nhân bánh thường là trứng, mực, tôm. Bánh căn ăn kèm với nước mắm chua ngọt, mỡ hành.','https://res.cloudinary.com/dt5xizv10/image/upload/postDetail/foodnt'),
